...
<div class="span-15 fright last">
    <div class="cont-links">
        ...
        <a href="http://www.ebhsa.com.ar/" class="link-1" target="_blank" title="Electromecánica Bottino S.A."><img src="public/images/bottino-iso-24.png" alt="" width="24" height="24" /><span>&nbsp;EBHSA Electromec&aacute;nica</span></a>
    </div>
    <div class="cont-search">
        <form id="form-search" action="<?=site_url('/productos/search/');?>" method="post" enctype="application/x-www-form-urlencoded">
            ...
            <a href="javascript:void($('#form-search').submit())" class="fleft"><img src="public/images/icon-search.png" alt="" width="21" height="21" /></a>
        </form>
    </div>
</div>
