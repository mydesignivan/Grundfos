...
<body>
    ...
    <div class="container">
        ...
        <?php
            ...
            if( isset($content['childs']) || isset($content['gallery']) ) require(APPPATH . 'views/includes/sidebar_inc.php');
            if( $this->uri->segment(1)=="productos" && isset($info['childs']) ) require(APPPATH . 'views/includes/sidebar_products_inc.php');
        ?>
        </div>
