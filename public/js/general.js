$(function(){
    ...
    if( (a=$("#slider")).length>0 ){
        a.easySlider({
            prevText : '<img src="public/images/icon-arrow-left.png" alt="Prev" width="35" height="53" />',
            nextText : '<img src="public/images/icon-arrow-right.png" alt="Next" width="35" height="53" />'
        });
    }
